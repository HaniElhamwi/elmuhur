const translations = {
  en: {
    ...
    sliderOneWelcome: "Al Mohar Trading Company",
    sliderOneHeading: "To manufacture high quality canned food",
    sliderOneText: "In the hands of experts in agriculture and production",
  ...
  ar: {
    ...
    /* slider one in landing page */
    sliderOneWelcome: "شركة المهور التجارية",
    sliderOneHeading: "لصناعة أطعمة معلبة عالية الجودة",
    sliderOneText: "بيد خُبراء في الزراعة و الإنتاج    ",
